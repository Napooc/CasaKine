      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <ScrollAnimation animation="scale-up" delay={600}>
            <Button onClick={() => navigate('/contact')} className="bg-gradient-accent hover-accent-glow text-white font-montserrat font-semibold px-12 py-4 text-lg rounded-full shadow-strong transition-all duration-300 hover:scale-110">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollAnimation animation="slide-left">
              <div>
                ...
                <Button onClick={() => navigate('/contact')} className="bg-gradient-accent hover-accent-glow text-white px-8 py-3">
