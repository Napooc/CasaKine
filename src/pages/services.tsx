...
import { Activity, Heart, Zap, Shield, Clock, CheckCircle, Star, ArrowRight, Stethoscope, Target, Users, Award, Baby } from 'lucide-react';
    ...
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src="/lovable-uploads/ff593693-5ff7-4abc-a290-5896e5cada6e.png" 
            alt="Centre de kinésithérapie - Équipements modernes" 
          ...
          <ScrollAnimation animation="scale-up" delay={800}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Button 
                ...
                className="morph-button bg-gradient-accent hover-accent-glow text-white font-montserrat font-semibold px-12 py-4 text-lg rounded-full shadow-strong transition-all duration-300 hover:scale-110"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                ...
                return (
                  <div 
                    key={index} 
                    className="glass-card p-6 text-center transition-all duration-500 hover:scale-110 hover-glow cursor-pointer" 
          ...
          <ScrollAnimation animation="fade-up">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-neutral-light max-w-3xl mx-auto">
                Une expertise reconnue dans trois domaines essentiels de la kinésithérapie moderne
              </p>
            </div>
          </ScrollAnimation>
            ...
            {mainServices.map((service, index) => {
              ...
              return (
                <ScrollAnimation key={index} animation="fade-up" delay={index * 200}>
                  <Card 
                    className={`glass-card border-2 ${service.borderColor} shadow-soft hover:shadow-strong transition-all duration-500 hover:scale-105 h-full group bg-gradient-to-br ${service.bgGradient} cursor-pointer hover:shadow-2xl ${service.glowColor}`} 
                    onClick={() => navigate(service.route)}
                  >
                    <CardContent className="p-10">
                      <div className="flex flex-col space-y-6">
                        ...
                        <div className="pt-4">
                          <Button variant="ghost" className={`${service.color} hover:bg-white/20 hover:text-black group-hover:translate-x-2 transition-all duration-300 w-full`}>
                            En savoir plus
