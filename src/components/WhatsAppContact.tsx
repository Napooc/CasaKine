...
const WhatsAppContact = () => {
  const phoneNumber = "+212661677096"; // Nawal El Ghorfi WhatsApp number
  const defaultMessage = "Bonjour Nawal El Ghorfi, je souhaiterais prendre rendez-vous pour une consultation en kinésithérapie.";
