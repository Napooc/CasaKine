      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'glass-effect shadow-strong' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo Premium */}
            <Link to="/" className="flex items-center space-x-4 group" onClick={e => {
            if (location.pathname === '/') {
              ...
              <div className="relative flex items-center space-x-3">
                <div className="relative overflow-hidden rounded-full bg-white p-2 shadow-soft">
                  <img src="/lovable-uploads/369c1f5b-ed08-439c-a09b-58bc3f177c61.png" alt="Dr. Nawal El Ghorfi - Kinésithérapeute D.E." className="h-12 w-auto transition-transform duration-300 group-hover:scale-105" />
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-montserrat font-medium text-sm text-neutral-light leading-tight">Kinésithérapeute</span>
                </div>
              </div>
            </Link>
