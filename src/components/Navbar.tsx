...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'ACCUEIL', path: '/', icon: Home, color: 'hover:text-primary' },
    { name: 'À PROPOS', path: '/about', icon: Heart, color: 'hover:text-medical-red' },
    { name: 'SERVICES', path: '/services', icon: Stethoscope, color: 'hover:text-secondary' },
    { name: 'GALERIE', path: '/gallery', icon: Camera, color: 'hover:text-accent' },
    { name: 'CONTACT', path: '/contact', icon: Phone, color: 'hover:text-primary-light' },
    { name: 'BLOG', path: '/blog', icon: PenTool, color: 'hover:text-secondary-light' },
  ];
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Animated underline */}
                    <div className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 bg-gradient-accent transition-all duration-300 ${
