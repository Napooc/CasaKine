          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <img 
                  src="/lovable-uploads/578eca18-a17b-4413-8596-3d1fe86712c9.png" 
              ...
              <div className="hidden md:flex flex-col">
                <span className="font-playfair font-bold text-lg text-primary leading-tight">Dr. Nawal El GHORFI</span>
                <span className="font-montserrat text-sm text-neutral font-medium">Kinésithérapeute D.E.</span>
              </div>
            </Link>
