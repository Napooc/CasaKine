...
const SpecialtyModal: React.FC<SpecialtyModalProps> = ({
  ...
  return <div className="fixed inset-0 z-50 overflow-hidden">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm transition-opacity duration-300" onClick={onClose} style={{
            ...
            <CardContent className="p-0">
              ...
              <div className="relative bg-gradient-to-r from-primary via-primary/90 to-secondary p-4 sm:p-6 lg:p-8 text-white overflow-hidden">
                ...
                <div className="relative z-10 flex items-start justify-between">
                  ...
                  <Button variant="ghost" size="icon" onClick={onClose} className="text-white hover:bg-white/20 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex-shrink-0 ml-2 transition-all duration-200 hover:scale-110" style={{
                  touchAction: 'manipulation'
                }}>
              ...
              <div className="p-4 sm:p-6 lg:p-8 max-h-[70vh] sm:max-h-[60vh] overflow-y-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    <div className="relative overflow-hidden rounded-xl lg:rounded-2xl shadow-lg">
                      <img src={specialty.detailedInfo.image} alt={specialty.title} className="w-full h-48 sm:h-64 lg:h-80 object-cover transition-transform duration-500 hover:scale-110" />
                  ...
                  <div className="space-y-6 lg:space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 lg:space-y-3">
                        {specialty.detailedInfo.benefits.map((benefit, index) => <div key={index} className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        return <div key={index} className="flex items-center space-x-3 p-3 bg-gradient-accent/5 rounded-xl border border-accent/10 hover:bg-gradient-accent/10 transition-all duration-200">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {specialty.detailedInfo.conditions.map((condition, index) => <div key={index} className="flex items-center space-x-3 p-2 rounded-lg hover:bg-neutral-lightest/50 transition-colors duration-200">
                ...
                <div className="mt-8 lg:mt-10 text-center border-t border-neutral-light/20 pt-6 lg:pt-8">
                  <Button className="morph-button bg-gradient-accent hover-accent-glow text-white font-montserrat font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-full shadow-strong transition-all duration-300 hover:scale-105 w-full sm:w-auto" onClick={() => {
                  navigate('/contact');
                  onClose();
                }} style={{
                  touchAction: 'manipulation'
