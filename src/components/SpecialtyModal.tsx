            ...
            <CardContent className="p-0">
              ...
              <div className="relative bg-gradient-to-r from-primary via-primary/90 to-secondary p-8 text-white overflow-hidden">
                ...
                <div className="relative z-10 flex items-start justify-between">
                  ...
                  <Button variant="ghost" size="icon" onClick={onClose} className="text-white hover:bg-white/20 w-12 h-12 rounded-full">
                    <X className="w-6 h-6" />
                  </Button>
                </div>
              </div>
              ...
              <div className="p-8 max-h-[60vh] overflow-y-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-6">
                    <div className="relative overflow-hidden rounded-2xl shadow-lg">
                      <img src={specialty.detailedInfo.image} alt={specialty.title} className="w-full h-80 object-cover transition-transform duration-500 hover:scale-110" />
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {specialty.detailedInfo.techniques.map((technique, index) => <span key={index} className="px-3 py-1 bg-gradient-accent/10 text-accent rounded-full text-sm font-medium">
                            {technique}
                          </span>)}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {specialty.detailedInfo.conditions.map((condition, index) => <div key={index} className="flex items-center space-x-2">
                ...
                <div className="mt-10 text-center">
                  <Button className="morph-button bg-gradient-accent hover-accent-glow text-white font-montserrat font-semibold px-8 py-4 rounded-full shadow-strong transition-all duration-300 hover:scale-105" onClick={() => {
